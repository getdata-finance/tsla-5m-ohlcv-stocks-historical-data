...
**TSLA 5m OHLCV stocks historical data** — ultra high-quality 5m OHLCV for **Tesla**. Clean `time, open, high, low, close, volume` CSV for backtesting, algorithmic trading and quantitative research.
...
- **Free evaluation sample** on GitHub (`5m`) · **11 timeframes** on [getdata.finance](https://getdata.finance/datasets/tsla) · **123,425** `5m` rows in the full archive
- Built for **backtesting**, **algorithmic trading** and **quantitative finance** workflows
- **Weekly refresh** — [getdata.finance](https://getdata.finance) every **Saturday, 8am UTC+0**; GitHub `5m` sample updated in sync

> **Sample on GitHub** · `TSLA_5m.csv` (11,088 rows, `2026-02-06` -> `2026-09-01`, 1.15 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/tsla)** — **123,425** `5m` rows (full `1m`: 617,080), **11 timeframes**, `2020-02-25` -> `2026-09-01`.
...
| 5m rows | 11,088 | **123,425** |
| Size | 1.15 MB | full ZIP on [getdata.finance](https://getdata.finance/datasets/tsla) |
...
| --- | --- | --- | --- | --- | --- |
| 2026-02-06T20:00:00+00:00 | 409.61 | 409.61 | 408.9 | 409.13 | 771 |
| 2026-02-06T20:05:00+00:00 | 409.13 | 409.56 | 408.86 | 408.91 | 681 |
| 2026-02-06T20:10:00+00:00 | 408.91 | 409.98 | 408.76 | 409.86 | 726 |
| 2026-02-06T20:15:00+00:00 | 409.86 | 410.39 | 409.62 | 410.27 | 744 |
| 2026-02-06T20:20:00+00:00 | 410.27 | 410.46 | 409.48 | 409.65 | 692 |

**Last rows**

| time | open | high | low | close | volume |
| --- | --- | --- | --- | --- | --- |
| 2026-09-01T19:35:00+00:00 | 354.91 | 354.91 | 354.37 | 354.39 | 363 |
| 2026-09-01T19:40:00+00:00 | 354.39 | 355.34 | 354.37 | 355.34 | 490 |
| 2026-09-01T19:45:00+00:00 | 355.34 | 355.67 | 354.66 | 355.1 | 519 |
| 2026-09-01T19:50:00+00:00 | 355.1 | 355.48 | 354.55 | 354.9 | 688 |
| 2026-09-01T19:55:00+00:00 | 354.9 | 355.27 | 354.72 | 355.26 | 899 |
...
df = pd.read_csv('TSLA_5m.csv', parse_dates=['time'])
...
The complete **TSLA** archive on **[getdata.finance](https://getdata.finance/datasets/tsla)** includes **11 OHLCV timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W) — **123,425** rows at `5m`, plus all other timeframes in the same ZIP.
